...
int main() {
    ...
    std::string cfg_path  = std::string(TKDNN_PATH) + "/tests/darknet/cfg/yolov4-tiny-darpa.cfg";
    std::string name_path = std::string(TKDNN_PATH) + "/tests/darknet/names/kdarpa.names";
